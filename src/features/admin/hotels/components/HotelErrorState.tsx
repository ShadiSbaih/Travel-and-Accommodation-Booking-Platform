...
interface HotelErrorStateProps {
  onRetry: () => void;
}

function HotelErrorState({ onRetry }: HotelErrorStateProps) {
  return (
    <Paper
      elevation={0}
      sx={{
    ...
    >
      ...
      >
        Something went wrong while fetching the hotels. Please try again.
      </Typography>
...
export default HotelErrorState;
